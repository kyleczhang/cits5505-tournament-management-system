/* Injects the shared navbar and footer so every page stays in sync without
   a templating engine. Each page just places <div data-layout="nav"></div>
   and <div data-layout="footer"></div> wherever it wants them.
   When we move to Flask/Jinja these become {% include %} partials. */
    ...
    <div class="container">
      <div class="row g-4">
        ...
        <div class="col-md-4 col-lg-4">
          <h5>Team</h5>
          <p class="mb-0">Built by the CITS5505 Agile team — Hafiz, Leon, Cheng. UWA, 2026.</p>
        </div>
      </div>
